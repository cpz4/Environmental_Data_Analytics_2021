...
NTL.phys.data.filteryear <- filter(NTL.phys.data, year4 == 1999)
...
```{r}
# One selection, when changes are made to that selection, and so on. 
...
# filter for rows and select for columns. 
