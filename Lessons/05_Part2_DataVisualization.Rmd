...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  ...
  geom_text(x = as.Date("2020-01-01"), y = 45, label = "good", hjust = 1, fontface = "bold") +   # hjust = 1 means left align, hjust = horiozontal justification. 
...
library(cowplot)
#         plots, columns or rows and how many, alihgn, relative heights 
