...
#5 Write PM2.5 in AQS_PARAMETER_DES
...
```{r}
# 12 Summaries
# Logic: Take data by site, month and year. Take the mean of all data from 1 site in a specific month in a specific year and calculate the mean. 
