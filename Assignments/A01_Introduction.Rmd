...
> Answer: I took ENVIRON710 Applied Data Analysis for Environmental Social Science, where we used R. I have no previous experience with data analytics or Git. 

2. Are there any components of the course about which you feel confident?

> Answer: The ggplot package and linear regression models (coding and interpretation).
...
> Answer: https://github.com/cpz4/Environmental_Data_Analytics_2021.git
