...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Option 1: Create and object and change the Effect column from string}
\CommentTok{# to factor so the function summary works. }
...
\includegraphics{Zarate_A03_DataExploration_files/figure-latex/geom_freqpoly-1.pdf}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Number of studies by publication year by test location"}\NormalTok{,}
       \DataTypeTok{x =} \StringTok{"Publication year"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Count"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Zarate_A03_DataExploration_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\includegraphics{Zarate_A03_DataExploration_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\includegraphics{Zarate_A03_DataExploration_files/figure-latex/unnamed-chunk-10-1.pdf}
...
\includegraphics{Zarate_A03_DataExploration_files/figure-latex/boxplot-1.pdf}
...
\includegraphics{Zarate_A03_DataExploration_files/figure-latex/violin-1.pdf}
